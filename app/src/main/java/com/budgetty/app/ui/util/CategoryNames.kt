...
private val categoryNameRes: Map<String, Int> = mapOf(
    ...
    // Taxonomy expansion 2026-08 — Bills & Finance group, Transportation/Health/Dining fills, and the
    // two new halves of the Insurance & Utilities split (the survivor "Utilities" is mapped above).
    "Bills & Finance" to R.string.cat_bills_finance,
    "Loan Repayment" to R.string.cat_loan_repayment,
    "Taxes" to R.string.cat_taxes,
    "Bank & Fees" to R.string.cat_bank_fees,
    "Savings" to R.string.cat_savings,
    "Public Transport" to R.string.cat_public_transport,
    "Taxi & Rideshare" to R.string.cat_taxi_rideshare,
    "Parking" to R.string.cat_parking,
    "Tolls & Vignette" to R.string.cat_tolls_vignette,
    "Dental" to R.string.cat_dental,
    "Optical" to R.string.cat_optical,
    "Coffee & Cafés" to R.string.cat_coffee_cafes,
    "Bars & Nightlife" to R.string.cat_bars_nightlife,
    "Childcare" to R.string.cat_childcare,
    "Mortgage" to R.string.cat_mortgage,
    "Insurance" to R.string.cat_insurance,
    "Phone & Internet" to R.string.cat_phone_internet,
